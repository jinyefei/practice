...
<body>
		<form action="${pageContext.request.contextPath}/adminAddProductServlet" method="post">
			...
			<td align="left"><input type="text" name="pname" size="80"/></td>
		</tr>
		<tr>
			<td align="center">商场价格</td>
			<td align="left"><input type="text" name="market_price" size="80"/></td>
		</tr>
		<tr>
			<td align="center">门店价格</td>
			<td align="left"><input type="text" name="shop_price" size="80"/></td>
		</tr>
		<tr>
			<td align="center">商品图片</td>
			<td align="left"><input type="file" name="pimage" size="80"/></td>
		</tr>
		<tr>
